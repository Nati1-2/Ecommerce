...
export default function VendorOrdersPage() {
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto">
      <div>
        <h1 className="text-2xl font-bold text-slate-900 ">Customer Orders & Fulfillment</h1>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        ...
        <div className="bg-white  p-4 rounded-2xl border border-slate-200  shadow-sm flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xl font-bold text-slate-900 ">{processingCount}</p>
          </div>
        </div>
        ...
        <div className="bg-white  p-4 rounded-2xl border border-slate-200  shadow-sm flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xl font-bold text-slate-900 ">{shippedCount}</p>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="relative w-full sm:w-64">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-1.5 text-xs bg-slate-50  text-slate-900  rounded-xl border border-slate-200  outline-none focus:ring-2 focus:ring-blue-600"
            />
          </div>
        </div>
