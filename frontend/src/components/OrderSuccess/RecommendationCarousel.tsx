  ...
  return (
    <div className="space-y-5 select-none">
      <div className="flex items-center justify-between">
        <h3 className="text-base font-black text-gray-900">You May Also Like</h3>
      </div>
            ...
            >
              ...
              <div className="relative aspect-square w-full rounded-xl bg-gray-50 flex items-center justify-center overflow-hidden border border-gray-100/30">
                ...
                <button
                  ...
                  className={cn(
                    "absolute top-2 right-2 w-7.5 h-7.5 rounded-full flex items-center justify-center shadow-sm border border-gray-100 bg-white hover:scale-105 transition-all",
                    isWish ? "text-rose-500" : "text-gray-400 hover:text-gray-600"
                  )}
                >
                  <Heart className={cn("w-4 h-4", isWish ? "fill-rose-500" : "")} />
                </button>
              </div>
