...
export default function RatingChart() {
  ...
  return (
    <div className="bg-white  p-6 rounded-3xl border border-slate-200  shadow-sm flex flex-col md:flex-row items-center gap-8">
      {/* Overall Score */}
      <div className="flex flex-col items-center justify-center p-6 bg-slate-50  rounded-2xl shrink-0 text-center w-full md:w-48">
        <span className="text-4xl font-black text-slate-900 ">4.88</span>
