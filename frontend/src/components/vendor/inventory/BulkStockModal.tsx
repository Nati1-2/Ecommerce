        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full mt-1.5 px-4 py-2.5 text-xs bg-slate-50  text-slate-900  rounded-xl border border-slate-200  font-bold outline-none focus:ring-2 focus:ring-blue-600"
            />
          </div>

          <div className="relative border-2 border-dashed border-slate-200  p-4 rounded-2xl text-center bg-slate-50/50 ">
